...
describe('Test EntityVersionPage component', () => {
  ...
  it('Checks if the DashboardVersion component renderst if respective data pass', async () => {
    mockParams = {
  ...
  it('Checks if the PipelineVersion component renderst if respective data pass', async () => {
    mockParams = {
      entityType: 'pipeline',
      version: '0.1',
  ...
  it('Checks if the TopicVersion component renderst if respective data pass', async () => {
    mockParams = {
      entityType: 'topic',
      version: '0.1',
